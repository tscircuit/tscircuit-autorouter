...
def run(c):
 ...
 r=json.loads(p.read_text());summary={**c,**{k:v for k,v in r.items() if k not in ['errors','effectiveInputSrj','routedSrj','pointPairSrj','routedTraces','stack']}}
