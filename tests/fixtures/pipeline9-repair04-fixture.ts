...
export function createPipeline9Repair04Fixture(): Pipeline9Repair04Fixture {
  ...
  const srj: SimpleRouteJson = {
    ...
    connections: [...hdRoutes.map((route) => ({
      ...
      pointsToConnect: [
        { x: -20, y: 25, layer: "top", pointId: "pcb_port_preload_start", pcb_port_id: "pcb_port_preload_start" },
        { x: 20, y: 25, layer: "top", pointId: "pcb_port_preload_end", pcb_port_id: "pcb_port_preload_end" },
      ],
    }],
    obstacles: [
      {
    ...
    traces: [{
      ...
      route: [
        { route_type: "wire", x: -20, y: 25, width: 0.15, layer: "top", start_pcb_port_id: "pcb_port_preload_start" },
        { route_type: "wire", x: 20, y: 25, width: 0.15, layer: "top", end_pcb_port_id: "pcb_port_preload_end" },
      ],
    }],
  }
