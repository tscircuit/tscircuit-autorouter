...
import type { MultiHeadPolyLineIntraNodeSolver2 } from "lib/solvers/HighDensitySolver/MultiHeadPolyLineIntraNodeSolver/MultiHeadPolyLineIntraNodeSolver2_Optimized"
import type { MHPoint2, PolyLine2 } from "lib/solvers/HighDensitySolver/MultiHeadPolyLineIntraNodeSolver/types2"

// Frozen pre-optimization force calculation from b592e311. Keep the original
// pair preparation and arithmetic as an independent differential reference.
export function applyForcesReference(this: MultiHeadPolyLineIntraNodeSolver2, polyLines: PolyLine2[]): {
