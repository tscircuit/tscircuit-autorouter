...
import realFootprints from "../../fixtures/bug-reports/sii9022-hdmi-fanout-identity/sii9022-hdmi-real-footprints.circuit.json" with {
  type: "json",
}
...
export const getSii9022HdmiRouteVisualization = ({
  inputSrj,
  traces,
  status,
}: {
  ...
  const circuitJson = [
    {
      type: "pcb_board",
      pcb_board_id: "sii9022_hdmi_route_board",
      center: { x: 0, y: 0 },
      width: 80,
      height: 26,
      thickness: 1.6,
