...
import input03 from "../../fixtures/features/via-high-density/via-high-density03-input.json" with { type: "json" };
...
test("FixedTopologyHighDensityIntraNodeSolver test", () => {
  ...
  const srj = createSrjFromNodeWithPortPoints(
    input03.nodeWithPortPoints as any,
  );
