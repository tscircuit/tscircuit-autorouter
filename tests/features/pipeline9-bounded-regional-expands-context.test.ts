...
// Reduced from the hosted SRJ18 sample 4 output: nearby routed copper couples
// errors that previously required a second, wider repair context.
test("bounded regional repair clears coupled contacts within its shared work budget", (): void => {
