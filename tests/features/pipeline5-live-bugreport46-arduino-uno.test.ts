...
import bugReport from "../../fixtures/bug-reports/bugreport46-ac4337/bugreport46-ac4337-arduino-uno.json" with { type: "json" };
...
test.skip(
  ...
  async () => {
    ...
    const highDensitySolver = solver.highDensityRouteSolver as
      Pipeline5HdCacheHighDensitySolver | undefined;
