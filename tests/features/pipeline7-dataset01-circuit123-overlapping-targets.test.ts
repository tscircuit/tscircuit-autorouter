...
test("pipeline7 dataset01 circuit123 keeps overlapping targets reachable", (): void => {
  const circuit123 = (dataset01 as Record<string, unknown>)
    .circuit123 as SimpleRouteJson
  const solver = new AutoroutingPipelineSolver7_MultiGraph(
    structuredClone(circuit123),
