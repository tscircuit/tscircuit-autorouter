...
import srj from "../../fixtures/bug-reports/bugreport68-solar-battery-charger/bugreport68-solar-battery-charger.srj.json" with { type: "json" };
...
test(
  ...
  () => {
    ...
    if (!routedTraces) {
      throw new Error(
        "Expected solar battery fixture to produce routed traces",
      );
    }
