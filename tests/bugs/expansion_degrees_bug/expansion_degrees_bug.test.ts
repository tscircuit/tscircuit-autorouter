import input19 from "./expansion_degrees_bug_bugreport19.json" with { type: "json" };
import input1 from "./expansion_degrees_bug_bugreport1.json" with { type: "json" };
import input16 from "./expansion_degrees_bug_bugreport16.json" with { type: "json" };
...
test(
  "expansion degree " + EXPANSION_DEGREEs.join(",") + "snapshot bugreport19",
  () => {
...
test(
  "expansion degree " + EXPANSION_DEGREEs.join(",") + "snapshot bugreport1",
  () => {
...
test(
  "expansion degree " + EXPANSION_DEGREEs.join(",") + "snapshot bugreport16",
  () => {
