...
import bugReport from "../../fixtures/bug-reports/simplification-trace-overlap-repro/simplification-trace-overlap-repro.json" with { type: "json" };
...
const convertHdRoutesToPcbTraces = (
  ...
  srjWithPointPairs.connections.flatMap((connection) => {
    ...
    return hdRoutes
      ...
      .map((route, index): SimplifiedPcbTrace => ({
        type: "pcb_trace",
