...
export default () => {
  return (
    <div>
      ...
      <ul>
        <li><strong>signal_data:</strong> 0.15mm (explicit standard)</li>
        <li><strong>signal_clock:</strong> 0.15mm (default)</li>
        <li><strong>power_3v3:</strong> 0.3mm (2x multiplier)</li>
        <li><strong>power_5v:</strong> 0.6mm (4x multiplier)</li>
        <li><strong>power_12v:</strong> 1.2mm (explicit thick)</li>
        <li><strong>power_main:</strong> 0.8mm with 1.0mm via</li>
      </ul>
