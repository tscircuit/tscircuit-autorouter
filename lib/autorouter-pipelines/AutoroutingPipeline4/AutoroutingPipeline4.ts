...
type PipelineStep<T extends new (...args: any[]) => BaseSolver> = {
  ...
  getConstructorParams: (
    instance: AutoroutingPipeline4,
  ) => ConstructorParameters<T>
  onSolved?: (instance: AutoroutingPipeline4) => void
}
...
>(
  solverName: keyof AutoroutingPipeline4,
  solverClass: T,
  getConstructorParams: (instance: AutoroutingPipeline4) => P,
  opts: {
    onSolved?: (instance: AutoroutingPipeline4) => void
  } = {},
): PipelineStep<T> {
...
/*
 * This preRectDiff Autorouting with very minimal features
 * ref: 8b8fe944 this commit was used to get this files
 */

export class AutoroutingPipeline4 extends BaseSolver {
...
export const CapacityMeshSolver = AutoroutingPipeline4
export type CapacityMeshSolver = AutoroutingPipeline4
