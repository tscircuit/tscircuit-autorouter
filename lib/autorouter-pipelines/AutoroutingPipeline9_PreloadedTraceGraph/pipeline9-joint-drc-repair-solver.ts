...
export class Pipeline9JointDrcRepairSolver extends BaseSolver {
  ...
  override _step(): void {
    ...
    const initialTerminalEscapeResult = applyPipeline9TerminalEscapeRelocations(
      {
        srj: this.params.srj,
    ...
    const targetedDetourResult = applyPipeline9TargetedObstacleDetours({
      srj: this.params.srj,
    ...
    this.combinedOutput = targetedDetourResult.routes
    this.stats = {
      ...this.stats,
      ...
      terminalEscapeCandidateCount:
        initialTerminalEscapeResult.attemptedCandidateCount,
      terminalEscapeAcceptedCount:
        initialTerminalEscapeResult.acceptedCandidateCount,
      targetedObstacleDetourCandidateCount:
        targetedDetourResult.attemptedCandidateCount,
      targetedObstacleDetourAcceptedCount:
        targetedDetourResult.acceptedCandidateCount,
    }
    this.solved = true
  }
