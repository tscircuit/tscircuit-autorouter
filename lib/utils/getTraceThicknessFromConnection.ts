 ...
 */
export function getMultiplierForThickness(thickness: number): number | undefined {
  const tolerance = 0.001 // 1 micron tolerance
  
  for (const [multiplier, standardThickness] of Object.entries(COMMON_TRACE_MULTIPLIERS)) {
