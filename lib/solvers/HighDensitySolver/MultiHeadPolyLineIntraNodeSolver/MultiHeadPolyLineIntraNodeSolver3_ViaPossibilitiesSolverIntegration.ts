...
export class MultiHeadPolyLineIntraNodeSolver3 extends MultiHeadPolyLineIntraNodeSolver2 {
  ...
  static override diagnosticFields = [
    ...MultiHeadPolyLineIntraNodeSolver2.diagnosticFields,
  ]
  override getSolverName(): string {
    return "MultiHeadPolyLineIntraNodeSolver3"
  }
  constructor(
    props: ConstructorParameters<typeof MultiHeadPolyLineIntraNodeSolver2>[0],
  ) {
    super(props)
  }
  createInitialCandidateFromSeed(shuffleSeed: number): Candidate | null {
    return this.call(
      () => this.binding.createInitialCandidateFromSeed(shuffleSeed),
      [shuffleSeed],
    )
  }
