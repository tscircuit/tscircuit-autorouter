...
import { findIntraNodePhysicalConflicts } from "./findIntraNodePhysicalConflicts"
...
/**
 * Solves an exact two-chord lane topology in narrow nodes: one top-to-bottom
 * chord crosses one left-to-right chord. The lateral chord remains direct
 * while the vertical chord changes layer at one of two legal edge lanes.
 */
