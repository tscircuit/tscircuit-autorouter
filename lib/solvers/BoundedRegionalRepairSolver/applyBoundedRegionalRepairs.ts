...
export type BoundedRegionalRepairResult = {
...
export type BoundedRegionalRepairParams = {
...
export const applyBoundedRegionalRepairs = ({
  originalSrj,
  routes,
  syntheticConnectionNames,
  drcEvaluator,
  viaHoleDiameter,
}: BoundedRegionalRepairParams): BoundedRegionalRepairResult => {
  const result: BoundedRegionalRepairResult = {
    routes,
  ...
  while (
    ...
    const candidateRoutes = applyClearanceProjection({
      originalSrj,
