...
const TINY_SOLVE_GRAPH_BASE_OPTIONS: TinyHyperGraphSolverOptions = {
  ...
  SELECTIVE_RERIP_PORT_CONFLICT_COST: DUPLICATE_PORT_TRAVERSAL_PENALTY,
...
const MAX_CONNECTIONS_FOR_DUPLICATE_CONGESTED_PORT_PREPASS = 1_000
const MIN_SOLVE_GRAPH_ITERATIONS = 2_000_000
const SOLVE_GRAPH_ITERATIONS_PER_CONNECTION = 8_000
