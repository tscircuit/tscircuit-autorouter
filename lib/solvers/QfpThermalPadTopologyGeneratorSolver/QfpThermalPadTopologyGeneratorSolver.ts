...
export interface QfpThermalPadTopologyGeneratorSolverParams extends TopologyGeneratorSolverParams {}

export interface QfpThermalPadTopologyGeneratorSolverOutput extends TopologyGeneratorSolverOutput {
...
export class QfpThermalPadTopologyGeneratorSolver extends BaseSolver {
  ...
  override _step() {
    ...
    if (!thermalPadBounds) {
      this.failed = true;
      this.error =
        "QfpThermalPadTopologyGeneratorSolver requires a thermal pad";
      return;
    }
  ...
  getOutput(): QfpThermalPadTopologyGeneratorSolverOutput {
    if (!this.output) {
      throw new Error(
        "QfpThermalPadTopologyGeneratorSolver has not solved yet",
      );
    }
