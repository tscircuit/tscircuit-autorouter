...
use crate::normalize_pipeline9_drc_errors_for_repair::{string_array,via_ids,trace_id_by_via_id};
...
pub fn get_autorouting_via_elements_from_typed_traces<'a>(traces: impl Iterator<Item = &'a autorouting_drc::simplified_trace::SimplifiedTrace>) -> Vec<Value> {
