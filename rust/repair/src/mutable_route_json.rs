...
use crate::filter_pipeline9_drc_errors_against_baseline::{write_js_json, write_json_number, write_json_string};
...
mod tests {
    ...
    use crate::filter_pipeline9_drc_errors_against_baseline::js_json;
