...
const { IntraNodeRouteSolver } = await importReference<typeof import("../../../lib/solvers/HighDensitySolver/IntraNodeSolver")>("lib/solvers/HighDensitySolver/IntraNodeSolver.ts")
...
const snapshot = (solver: InstanceType<typeof IntraNodeRouteSolver>): unknown => {
...
const outputDirectory = resolve(process.argv[2] ?? "/tmp/intra-node-routing-parity")
