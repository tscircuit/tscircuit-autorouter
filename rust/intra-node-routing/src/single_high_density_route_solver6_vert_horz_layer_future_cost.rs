...
impl SingleHighDensityRouteSolver {
    pub fn new_future_cost(opts: Value) -> Self {
        Self::new_future_cost_typed(crate::single_high_density_route_solver::SingleRouteSolverOptions::from_value(opts))
    }

    pub fn new_future_cost_typed(mut opts: crate::single_high_density_route_solver::SingleRouteSolverOptions) -> Self {
