...
pub fn multi_head_mut(engine: &mut crate::specialized_solver::SpecializedEngine) -> Option<&mut super::multi_head_poly_line_intra_node_solver::MultiHeadPolyLineIntraNodeSolver> {
...
pub fn snapshot_identity(engine: &mut crate::specialized_solver::SpecializedEngine) -> Value {
...
pub fn restore_snapshot_identity(engine: &mut crate::specialized_solver::SpecializedEngine, identity: &Value) -> Result<(), String> {
...
pub fn invoke_with_identity(
    engine: &mut crate::specialized_solver::SpecializedEngine,
    method: &str,
    args: Vec<Value>,
    identity: Value,
