...
impl AutoroutingDrcEngine {
    ...
    pub fn stats(&self) -> Result<Ts<high_density_repair03::drc::autorouting_drc_engine::AutoroutingDrcEngineRunStats>, JsValue> {
...
pub(crate) struct GeneralState {
    ...
    engine: Option<capacity_autorouter::solvers::high_density_solver::intra_node_solver::IntraNodeRouteSolver>,
...
impl GeneralState {
    fn initialized(engine: capacity_autorouter::solvers::high_density_solver::intra_node_solver::IntraNodeRouteSolver) -> Self {
    ...
    pub(crate) fn set_cached_output(&mut self, routes: Vec<capacity_autorouter::types::high_density_types::Route>, solved: bool, failed: bool, error: Option<String>) {
...
fn repair_math() -> high_density_repair03::solvers::global_drc_force_improve_solver::solver_helpers::RepairMath {
...
pub struct RepairPadInput {
    #[tsify(type = "import('high-density-repair03/lib').HighDensityRoute")]
    route: Value,
    preferred: high_density_repair03::solvers::global_drc_force_improve_solver::internal_types::Point,
...
impl TargetedRepairEngine {
    ...
    pub fn trace(input: Ts<RepairTraceInput>, clearance: f64) -> Result<Ts<high_density_repair03::solvers::global_drc_force_improve_solver::find_trace_clearance_via_positions::TracePlacements>, JsError> {
        use high_density_repair03::solvers::global_drc_force_improve_solver::internal_types::{Segment, RoutePoint};
        use std::{cell::RefCell, rc::Rc};
