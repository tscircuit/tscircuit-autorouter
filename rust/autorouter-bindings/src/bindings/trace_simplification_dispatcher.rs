...
use intra_node_routing::specialized_base_solver::{SpecializedSolver};
use trace_simplification::{graph_codec::GraphCodec, types::*};
use trace_simplification::simplified_path_solver::{
...
use trace_simplification::useless_via_removal_solver::{
...
use trace_simplification::same_net_via_merger_solver::{SameNetViaMergerSolver, SameNetViaMergerSolverInput};
...
fn restore_shared_indexes(
    ...
    obstacles: &mut Rc<RefCell<trace_simplification::data_structures::obstacle_tree::ObstacleSpatialHashIndex>>,
    routes: &mut Rc<RefCell<trace_simplification::data_structures::high_density_route_spatial_index::HighDensityRouteSpatialIndex>>,
) -> Result<(), String> {
        ...
        let engine = match kind {
            "path-base" | "path" | "vertex" => {
                let params = SingleSimplifiedPathParams {
                    connectivity: Rc::new(RefCell::new(trace_simplification::connectivity_context::ConnectivityContext::new(conn_map.clone()))),
