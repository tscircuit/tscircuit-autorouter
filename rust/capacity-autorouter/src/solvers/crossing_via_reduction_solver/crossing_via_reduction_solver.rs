...
use crate::bindings::trace_simplification::high_density_route_spatial_index::{HighDensityRouteSpatialIndex, RouteConflict, RouteClearanceIndex};
use crate::data_structures::obstacle_tree::ObstacleSpatialHashIndex;
use crate::solvers::useless_via_removal_solver::{route_section::RouteSection,break_route_into_sections::break_route_into_sections,can_section_move_to_layer::can_section_move_to_layer};
...
impl SpecializedSolver for CrossingViaReductionSolver{
    ...
    fn _step(&mut self)->Result<(),String>{
        crate::bindings::trace_simplification::connectivity_read_barrier::check(&self.input.conn_map)?;
