    ...
    pub fn restore(
        ...
        Ok(Self {
            identity: value["$object"]
                .as_u64()
                .unwrap_or_else(crate::bindings::trace_simplification::types::next_identity),
            points_array_identity: fields["points"]["$array"]
                .as_u64()
                .unwrap_or_else(crate::bindings::trace_simplification::types::next_identity),
            start_index: fields["startIndex"]
                .as_u64()
                .ok_or("Route section startIndex required")? as usize,
            end_index: fields["endIndex"]
                .as_i64()
                .ok_or("Route section endIndex required")? as isize,
