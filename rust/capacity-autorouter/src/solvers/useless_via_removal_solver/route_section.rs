use crate::bindings::trace_simplification::types::PointRef;
...
impl RouteSection {
    pub fn snapshot(&self, codec: &mut crate::bindings::trace_simplification::graph_codec::GraphCodec) -> serde_json::Value {
    ...
    pub fn restore(value: &serde_json::Value, codec: &mut crate::bindings::trace_simplification::graph_codec::GraphCodec) -> Result<Self, String> {
        let fields = value.get("fields").unwrap_or(value);
        Ok(Self {
            identity: value["$object"].as_u64().unwrap_or_else(crate::bindings::trace_simplification::types::next_identity),
            points_array_identity: fields["points"]["$array"].as_u64().unwrap_or_else(crate::bindings::trace_simplification::types::next_identity),
