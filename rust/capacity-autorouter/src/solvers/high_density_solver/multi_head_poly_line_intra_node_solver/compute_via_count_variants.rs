use super::{
    get_every_combination_from_choice_array::get_every_combination_from_choice_array,
    types2::MHPoint2,
};
...
pub fn compute_via_count_variants(
    ...
    variants.retain(|variant| {
        pairs
            .iter()
            .enumerate()
            .all(|(i, (_, (start, _)))| start.z1 == start.z2 || variant[i] != 0)
    });
    variants.retain(|variant| {
