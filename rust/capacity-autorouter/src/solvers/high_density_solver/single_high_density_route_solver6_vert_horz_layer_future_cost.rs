...
use crate::solvers::high_density_solver::single_high_density_route_solver::{node_point, SingleHighDensityRouteSolver};
...
impl SingleHighDensityRouteSolver {
    ...
    pub fn new_future_cost_typed(mut opts: crate::solvers::high_density_solver::single_high_density_route_solver::SingleRouteSolverOptions) -> Self {
        if opts.nearby_segment_clearance.is_none() {
            ...
            opts.nearby_segment_clearance = Some(if clearance.is_finite() { clearance } else { 0.15 });
        }
