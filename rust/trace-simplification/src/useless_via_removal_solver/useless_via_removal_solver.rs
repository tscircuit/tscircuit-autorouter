...
use crate::types::{RouteRef, ObstacleRef, Point2, ConnectivityMap, Math};
...
impl UselessViaRemovalSolver {
    pub fn new(mut input: UselessViaRemovalSolverInput) -> Self {
        ...
        Self {
            identity: crate::types::next_identity(), unsimplified_routes_array_identity: crate::types::next_identity(),
            optimized_routes_array_identity: crate::types::next_identity(), unprocessed_routes_array_identity: crate::types::next_identity(),
...
impl UselessViaRemovalSolver {
    ...
    pub fn invoke(&mut self, method: &str, _args: &Value, codec: &mut crate::graph_codec::GraphCodec) -> Result<Value, String> {
        match method {
