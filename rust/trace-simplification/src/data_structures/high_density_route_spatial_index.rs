...
use crate::types::{Point, Point2, PointRef, RouteRef, point3};
use crate::math_utils::{do_segments_intersect, min, max};
...
impl HighDensityRouteSpatialIndex {
    pub fn new(routes: Vec<RouteRef>, cell_size: f64) -> Self {
        let mut index = Self { identity: crate::types::next_identity(), segment_buckets: IndexMap::new(), via_buckets: IndexMap::new(), cell_size, maximum_copper_radius: 0.0 };
