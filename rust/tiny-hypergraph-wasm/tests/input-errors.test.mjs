...
test("invalid inputs and premature output requests throw JavaScript errors", () => {
  ...
  assert.throws(() => new RustTinyHyperGraphSolver({}, problem, options), /Invalid topology/)
  assert.throws(() => new RustTinyHyperGraphSolver(topology, {}, options), /Invalid problem/)
  assert.throws(() => new RustTinyHyperGraphSolver(topology, problem, { MAX_ITERATIONS: "bad" }), /Invalid solver options/)
