...
use crate::types::{Bounds, Name, InputNodeWithPortPoints, NodeWithPortPoints, OwnerPair, SharedEdge};
use crate::determine_owner_pair::determine_owner_pair;
...
pub mod live {
    ...
    use crate::redistribute_port_points_on_shared_edge::redistribute_port_points_on_shared_edge;
    use crate::should_ignore_port_point::should_ignore_port_point;
    use crate::should_ignore_shared_edge::should_ignore_shared_edge;
