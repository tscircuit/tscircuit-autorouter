...
- Runs: 1.
- Average isolated solver duration: 10543.9ms.
- Duplicate congested-port prepass is the dominant retained-heap jump: about +704.7 MiB after GC.
...
- `optimizeSection` adds only about +58.6 MiB and finishes in about 0.000ms.
- Final retained memory after solve stays near 364.7 MiB heap / 731.1 MiB RSS.
...
- `solver:stage:optimizeSection`: 364.7 MiB.
- Largest retained-heap jumps per run:
- `run-001`: `solver:constructor:after-duplicateCongestedPortPrepass` (704.7 MiB).
