...
- CI group9 for frozen PR head associated with PR head `0e9cd6f8f4d31a09439948fed6e7f0155290ad8c`: **failed** — Bugreport94 reached its snapshot assertion after 571,967.35 ms; its first four assertions passed, including the at-most-five default DRC limit. The SVG comparison differed by 36.036%; no exact DRC count or expanded-zero result is inferred. Actual checkout was PR merge11e61e1319c04049cdf9ea61a5ed4ee113bc4988, not byte-identical frozen0e9cd6f8.
...
- GitHub Bun Test workflow associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b`: **passed** — Completed successfully for this associated PR head, workflow run 34004418653, attempt 2. This records the GitHub workflow, separately from the external Vercel preview status. The actual checkout was PR merge634985de9c5efc147a7645d3c68493fdc139567e, including upstream runtime changes; it was not byte-identical to the PR head.
- GitHub Build workflow associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b`: **passed** — Completed successfully for this associated PR head, workflow run 34004418558, attempt 1. This records the GitHub workflow, separately from the external Vercel preview status. The actual checkout was PR merge634985de9c5efc147a7645d3c68493fdc139567e, including upstream runtime changes; it was not byte-identical to the PR head.
- GitHub Type Check workflow associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b`: **passed** — Completed successfully for this associated PR head, workflow run 34004418604, attempt 1. This records the GitHub workflow, separately from the external Vercel preview status. The actual checkout was PR merge634985de9c5efc147a7645d3c68493fdc139567e, including upstream runtime changes; it was not byte-identical to the PR head.
- GitHub Format Check workflow associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b`: **passed** — Completed successfully for this associated PR head, workflow run 34004418661, attempt 2. This records the GitHub workflow, separately from the external Vercel preview status. The actual checkout was PR merge634985de9c5efc147a7645d3c68493fdc139567e, including upstream runtime changes; it was not byte-identical to the PR head.
- GitHub Vercel Build workflow associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b`: **passed** — Completed successfully for this associated PR head, workflow run 34004418592, attempt 1. This records the GitHub workflow, separately from the external Vercel preview status. The actual checkout was PR merge634985de9c5efc147a7645d3c68493fdc139567e, including upstream runtime changes; it was not byte-identical to the PR head.
- Linux CI group9 retry associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b`: **passed** — PR merge634985de retry job101410483299 passed:52 tests passed,7 skipped,0 failed;470 assertion calls. Bugreport94 passed all five unchanged assertions, including snapshot comparison, in519393.18ms. No exact DRC count or expanded-zero result is inferred. Workflow association is PR head984831c; the tested source was the merge commit.
...
The completed GitHub workflow associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b` is **passed**. Its actual checkout was merge `634985de9c5efc147a7645d3c68493fdc139567e` into base `fb6c6d77c091a56c9e1d4648bbac40a7cccd0def`. That merge adds a `rootConnectionName` assignment during preloaded-trace simplification, before repair03 and the saved benchmark checkpoint. It is not byte-identical to the delivery head. The original exact-head CI wording was inaccurate; this correction changes CI source attribution and leaves all sealed benchmark evidence unchanged.

**Large-board runtime:** The equivalent delivery test declares no timeout; CI owns the 1,200-second budget through `bun test --timeout 1200000`, increased from its previous 600,000 ms CLI setting. The expected SVG was updated after review to reflect the changed routing. Comparing the committed test sources confirms that all five original assertions, including the default DRC limit, targeted-overlap checks and snapshot assertion, are preserved. The CI test associated with PR head `984831c791a5cf6b5160ca293dd4d1a11971544b` ran actual merge `634985de9c5efc147a7645d3c68493fdc139567e` and **passed**. The test source is unchanged, but the merge contains the pre-repair03 runtime change described above. Recorded runtime: 519.39 seconds. A passing test establishes its at-most-five assertion; the log does not supply an exact DRC count. This larger budget acknowledges substantial runtime overhead. It is not evidence that the solver meets the old 300-second budget. The separately frozen bugreport94 benchmark checkpoint is sample054, which remains in both denominators. CI is not an additional dataset entry, and this merge-source audit does not establish that its pre-repair03 output equals that frozen checkpoint. A passing at-most-five default-DRC test is also not a claim that the expanded manufacturing checker reports zero errors.
